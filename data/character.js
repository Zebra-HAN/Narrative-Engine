...
const CHARACTER_NAV = {
  ...
  subs: [
    ...
    { id:'attribute',   label:'속성 빨리 수정좀 테스트중', icon:'⚡'  ,type:'group'  },
    { id:'ability',     label:'능력',   },
...
const CHARACTER_CARDS = {
 ...
 /* ════════════════════════════════════════════════
   ...
   archetype: [ 
    ...
    { icon:'⚔', img:'images/Giant_Elf.jpg', subImg:'images/Peep.png', name:'영웅의 이름이 엄청길어서 옆으로 튀어나오는 현상이 아이디어 통합 창에서 발견됐는데 이거 어떻게 해결하면 좋을까?',
